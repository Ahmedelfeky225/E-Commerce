  ...
  return (
    <div className="container mx-auto max-w-full sm:max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl py-20 px-3 flex flex-col gap-5">
      ...
      <div className="relative">
        <div className="absolute left-0 top-0 bottom-0 w-6 bg-gradient-to-r  from-white dark:bg-none to-transparent pointer-events-none z-10" />
        ...
        <div className="absolute right-0 top-0 bottom-0 w-6 bg-gradient-to-l dark:bg-none from-white to-transparent pointer-events-none z-10" />
      </div>
